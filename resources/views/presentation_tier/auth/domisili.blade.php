...
@section('content')
    {{-- Semua kode <link> dan <nav> sudah dihapus karena diwarisi dari layout --}}
        ...
        <div class="form-wrapper">
            ...
            <form action="{{ route('pengajuan.domisili.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="alamat-domisili" name="alamat_domisili" placeholder="Masukkan Alamat" required>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="rt-domisili" name="rt_domisili" placeholder="Masukkan RT Domisili" required>
                    </div>
                    <div class="form-group">
                        <label for="rw-domisili">RW Domisili</label>
                        <input type="number" id="rw-domisili" name="rw_domisili" placeholder="Masukkan RW Domisili" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrapper">
                            <input type="file" id="ktp" name="ktp" class="file-input" accept="image/*,application/pdf" capture="environment" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrapper">
                            <input type="file" id="kk" name="kk" class="file-input" accept="image/*,application/pdf" capture="environment" required>
                            <button type="button" class="file-choose-btn">Choose File</button>
                            <span class="file-name-display">No File Chosen</span>
                        </div>
                    </div>
